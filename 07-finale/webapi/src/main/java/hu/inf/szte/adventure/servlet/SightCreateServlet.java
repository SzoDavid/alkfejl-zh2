...
import hu.inf.szte.adventure.model.CreateSightReq;
...
@WebServlet(urlPatterns = {"/api/sight/add", "/api/sight/create", "/api/sight/new"})
public class SightCreateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        var gson = new Gson();
        var reqModel = gson.fromJson(req.getReader(), CreateSightReq.class);
        ...
        // TODO: more boring verifications ...
        var model = new Sight(
                null,
                reqModel.getName(),
                reqModel.getPrice(),
        ...
        dao.save(model);
        resp.getWriter().println(gson.toJson(new InsertId(model.getId())));
    }
}
